...
class SousRubriqueType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('introduction', TextareaType::class, ['label' => 'Introduction', 'label_attr' => ['class' => 'font-weight-bold'], 'attr' => ['placeholder' => 'Veuillez décrire la rubrique', 'spellcheck' => 'false', 'maxlength' => '500', 'rows' => '3', 'style' => 'resize:none; overflow:hidden;']])
