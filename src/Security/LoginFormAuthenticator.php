...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    {   
        ...
        $urlRecaptcha = "https://www.google.com/recaptcha/api/siteverify?secret={$this->parameterBag->get('google_recaptcha_secret')}&response={$credentials['g-recaptcha-response']}";
