...
class GoogleAnalyticsService {
     ...
     *
     */
    public function getDataDateRangeMetricsDimensions($viewId,$dateStart,$dateEnd,$metrics='sessions',$pageSize=null,$dimensions=null,$sorting=null,$filterMetric=null,$filterDimension=null) {
     ...
     * @return mixed
     */
    public function getAvgSessionDurationDateRange($viewId,$dateStart,$dateEnd) {
        return $this->getDataDateRange($viewId,$dateStart,$dateEnd,'avgSessionDuration');
    }
