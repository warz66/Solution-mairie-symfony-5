...
class AdminGalerieController extends AbstractController
{
     ...
     */
    public function index($page, GalerieRepository $repo, Request $request, PaginatorInterface $paginator, MessageDependenciesService $md)
    {   
        ...
        return $this->render('admin/galerie/index.html.twig', [
            'galeries' => $galeries,
            'galeriesWithDependencies' => $md->getMsgGaleriesDependencies($galeries->getItems()),
        ]);
    }
